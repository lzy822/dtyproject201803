...
public class StaticVariableEnum {
    ...
    public static final String JBNTGDBROOTPATH = Environment.getExternalStorageDirectory().toString() + "/临沧市基本农田/基本农田保护区.geodatabase";
    ...
    public static final String LCDKYROOTPATH = Environment.getExternalStorageDirectory().toString() + "/临沧市基本农田/临沧市级外业踏勘数据.geodatabase";
